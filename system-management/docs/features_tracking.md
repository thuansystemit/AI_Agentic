...
|---|----------|-------|--------|
| 1 | Who can create categories — ADMIN only or any user? | User | ⏳ Open |
| 2 | What happens to group permissions when a group is deleted? | User | ⏳ Open |
| 3 | If a user has no permission on a category, is it hidden or visible? | User | ⏳ Open |
